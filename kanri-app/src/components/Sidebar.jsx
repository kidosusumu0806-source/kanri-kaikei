...
export default function Sidebar({ tab, setTab, loc, setLoc, period, setPeriod, locations, setLocations, user, onLogout, computed, onExcel, savedMsg, onAddLocation, onAddPeriod }) {
  const [collapsed, setCollapsed] = useState(false);
  const allPeriods = Object.keys(locations[loc] || {});

  const addLocation = () => {
    if (onAddLocation) { onAddLocation(); return; }
  ...
  const addPeriod = () => {
    if (onAddPeriod) { onAddPeriod(); return; }
